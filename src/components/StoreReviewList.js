...
// const StoreReviewList = ({ storereviewList }) => {
...
//       }
//     };
//     const copyList = JSON.parse(JSON.stringify(storereviewList));
//     const filteredList =
...
//           <h4> 리뷰({storereviewList.length})개</h4>
//         </div>
